...
public class OpenAiController {
    ...
    public String askQuestion(@RequestParam String ingredients) {
        ...
        String q = "give me a recipe as json format only with these ingredients: " + ingredients + "The json should include the following attribute: name, description, instructions, author, origin, type, preparationTime, totalTime, category, difficulty and ingredients. " +
